...
class CommerceProductInlineEntityFormHandler extends EntityInlineEntityFormHandler {
  ...
  public function entityForm($entity_form, FormStateInterface $form_state) {
    ...
    // Attach fields.
    $langcode = $product->language()->id;
    field_attach_form($product, $entity_form, $form_state, $langcode);
  ...
  public static function entityFormValidate($entity_form, FormStateInterface $form_state) {
    ...
    $product_values = NestedArray::getValue($form_state['values'], $entity_form['#parents']);
    ...
    field_attach_form_validate($product, $entity_form, $form_state);
  }
